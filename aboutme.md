...
- 🥋 Near to be [Yellow Belt](https://pwn.college) on fantastic pwn.college judo (pwn executables martial arts)
...
I get 1st place in [CyberChallenge](https://cyberchallenge.it/) in individual competition within university context (32th place in national context on over 500 partecipants) and 12th/31 place in team competition national context in 2021.
...
| 💾 x8086 | High | Reversering and pwn skills for x86 executable |
| 💿 x64 | Medium | Reversering and pwn skills for x64 executable |
...
| 🔥 Firebase | Medium | No-Relational database used in Android app or web app (NodeJS)  |
...
| 🤯 Cryptography | Public-Key RSA | Very High | Knowledgment and exploitation of most vulnerabilties (Coppersmith and LLL's algorithm knownledgment) see [here](https://github.com/umb-hub/crypto-notebook/blob/master/Asymmetrical/RSA.ipynb) |
